...
public:
    UARTHandlerNode() : Node("uart_handler_node"), uart("/dev/ttyTHS1", B115200) { // UART port and baudrate TODO: check!
        ...
        twist_subscriber_ = this->create_subscription<geometry_msgs::msg::Twist>(
            "target_velocity", 10,
            std::bind(&UARTHandlerNode::sendTwist, this, std::placeholders::_1)
        );

        // Timer to read UART data every 50ms
        timer_ = this->create_wall_timer(
            std::chrono::milliseconds(50), // TODO is 50ms OK?
